...
/* ---------- 曲谱：{音高索引, 时长ms} 平铺 ----------
 * 音高索引（半音制，与 s_freq 完全一致）：0=休止 1=C4 2=C#4 3=D4 4=D#4
 *           5=E4 6=F4 7=F#4 8=G4 9=G#4 10=A4 11=A#4 12=B4 13=C5 14=C#5
 *           15=D5 16=D#5 17=E5 18=F5 19=F#5 20=G5 21=G#5 22=A5 23=A#5
 *           24=B5 25=C6 26=C#6 27=D6 28=D#6 29=E6 30=F6 31=F#6 32=G6
 *           33=G#6 34=A6 35=A#6 36=B6 37=C7 38=C#7 39=D7 40=D#7 41=E7
 *           42=F7 43=F#7 44=G7 45=G#7 46=A7
 *
...
static const uint16_t s_mario[] = {
    41,83, 41,83, 0,83, 41,83, 0,83, 37,83, 41,83, 0,83,
    44,83, 0,83, 0,83, 0,83, 32,83, 0,83, 0,83, 0,83,
    37,83, 0,83, 0,83, 32,83, 0,83, 0,83, 29,83, 0,83,
    0,83, 34,83, 0,83, 36,83, 0,83, 35,83, 34,83, 0,83,
    32,111, 41,111, 44,111, 46,83, 0,83, 42,83, 44,83, 0,83,
    41,83, 0,83, 37,83, 0,83, 39,83, 36,83, 0,83, 0,83,
    37,111, 0,111, 0,111, 32,83, 0,83, 0,83, 29,83, 0,83,
    0,83, 34,83, 0,83, 36,83, 0,83, 35,83, 34,83, 0,83,
    32,111, 41,111, 44,111, 46,83, 0,83, 42,83, 44,83, 0,83,
    41,83, 0,83, 37,83, 0,83, 39,83, 36,83, 0,83, 0,83
};
...
static const uint16_t s_imperial[] = {
    10,750, 10,750, 10,125, 10,125, 10,125, 10,125, 6,250, 0,250,
    10,500, 10,500, 10,500, 6,375, 13,125,
    10,500, 6,375, 13,125, 10,1000,
    17,500, 17,500, 17,500, 18,375, 13,125,
    22,500, 0,375, 0,125, 22,500, 21,375, 20,125,
    16,125, 15,125, 16,250, 0,250, 10,250, 16,500, 15,375, 14,125,
    13,125, 12,125, 13,125, 0,250, 6,250, 9,500, 6,375, 10,187,
    13,500, 10,375, 13,125, 17,1000
};

/* 曲 3：Happy Birthday（生日快乐）——经典 C 调版，25 音
 *       tempo 8=125ms（八分）/ 4=250ms（四分） */
static const uint16_t s_birthday[] = {
    8,125, 8,125, 10,125, 8,125, 13,250, 12,250,
    8,125, 8,125, 10,125, 8,125, 15,250, 13,250,
    8,125, 8,125, 20,125, 17,125, 13,125, 12,125, 10,250,
    18,125, 18,125, 17,125, 13,125, 15,250, 13,250
};

/* 曲 4：Twinkle Little Star（小星星）——1 拍=250ms（tempo 120），42 音 */
static const uint16_t s_twinkle[] = {
    1,250, 1,250, 8,250, 8,250, 10,250, 10,250, 8,500,
    6,250, 6,250, 5,250, 5,250, 3,250, 3,250, 1,500,
    8,250, 8,250, 6,250, 6,250, 5,250, 5,250, 3,500,
    8,250, 8,250, 6,250, 6,250, 5,250, 5,250, 3,500,
    1,250, 1,250, 8,250, 8,250, 10,250, 10,250, 8,500,
    6,250, 6,250, 5,250, 5,250, 3,250, 3,250, 1,500
};

/* 曲 5：Ode to Joy（欢乐颂）——4/4 拍，八分=125ms（tempo 120），32 音
 *       "3."=附点四分 375ms，"-"=二分 500ms */
static const uint16_t s_ode[] = {
    5,125, 5,125, 6,125, 8,125, 8,125, 6,125, 5,125, 3,125,
    1,125, 1,125, 3,125, 5,125, 5,375, 3,125, 3,125, 1,500,
    5,125, 5,125, 6,125, 8,125, 8,125, 6,125, 5,125, 3,125,
    1,125, 1,125, 3,125, 5,125, 3,375, 1,125, 1,125, 1,500
};

/* 曲 6：Two Tigers（两只老虎）——八分=125ms，"-"=二分 500ms，32 音 */
static const uint16_t s_tigers[] = {
    1,125, 3,125, 5,125, 1,125, 1,125, 3,125, 5,125, 1,125,
    5,125, 6,125, 8,500, 5,125, 6,125, 8,500,
    8,125, 10,125, 8,125, 6,125, 5,125, 1,125, 8,125, 10,125, 8,125, 6,125, 5,125, 1,125,
    1,125, 8,125, 1,500, 1,125, 8,125, 1,500
};
...
static const song_t s_songs[SONG_N] = {
    {"Mario Theme",         s_mario,    sizeof(s_mario) / 4},
    {"Imperial March",      s_imperial, sizeof(s_imperial) / 4},
    {"Happy Birthday",      s_birthday, sizeof(s_birthday) / 4},
    {"Twinkle Little Star", s_twinkle,  sizeof(s_twinkle) / 4},
    {"Ode to Joy",          s_ode,      sizeof(s_ode) / 4},
    {"Two Tigers",          s_tigers,   sizeof(s_tigers) / 4},
};
